...
FD-PD Player es una aplicación Android de reproducción de música local desarrollada como proyecto de fin de ciclo.  
...
Las listas permiten una reproducción separada de la principal, pudiendo elegir a reproducir solamente X canciones.

El reproductor permite seguir reproduciendo las canciones incluso teniendo la aplicación en segundo plano sin tener que mantener abierto específicamente el fragmento de reproducción.

La app cuenta con un sistema de usuarios. Al iniciar sesión, el usuario puede descargar canciones favoritas de otros usuarios o subir las suyas propias donde todos pueden verlo de forma pública.

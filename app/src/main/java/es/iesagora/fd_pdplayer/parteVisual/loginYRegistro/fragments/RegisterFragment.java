package es.iesagora.fd_pdplayer.parteVisual.loginYRegistro.fragments;
...
public class RegisterFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.btnCrearCuenta.setOnClickListener(v -> {
            ...
            String confirmarPassword = binding.tVConfirmarContrasenia.getText() != null
                    ? binding.tVConfirmarContrasenia.getText().toString()
                    : "";

            if (!validarCampos(usuario, correo, password, confirmarPassword)) {
                return;
            }
    ...
    private boolean validarCampos(String usuario, String correo, String password, String confirmarPassword) {
    ...
    private void setLoading(boolean loading) {
        ...
        binding.tVConfirmarContrasenia.setEnabled(!loading);
